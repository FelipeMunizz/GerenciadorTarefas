...
public class ProjetosRepository : IProjetosRepository
{
    ...
    public async Task<object> ListarUsuariosProjeto(int idProjeto)
    {
        ...
        while (reader.Read())
        {
            ...
            {
                IdUsuarioProjeto = (int)reader["ID_USUARIO_PROJETO"],
                IdUsuario = (int)reader["ID_USUARIO"],
                IdProjeto = (int)reader["ID_PROJETO"],
    ...
    public async Task<UsuariosProjeto> ObterUsuarioProjeto(int idUsuarioProjeto)
    {
        ...
        if (reader.Read())
        {
            usuariosProjeto.IdUsuarioProjeto = (int)reader["ID_USUARIO_PROJETO"];
            usuariosProjeto.IdUsuario = (int)reader["ID_USUARIO"];
            usuariosProjeto.IdProjeto = (int)reader["ID_PROJETO"];
